...
main = tkinter.Tk()
main.title("Predicting Influencers in Social Networks: Twitter Influencer Prediction Model")
...
font = ('times', 16, 'bold')
title = Label(main, text='Predicting Influencers in Social Networks: Twitter Influencer Prediction Model')
